...
public class Register {
    ...
    static Denomination oneHundredNote = new Denomination("One Hundred Note", 100.00, "bill", "placeholder");
    static Denomination fiftyNote = new Denomination("Fifty Note", 50.00, "bill", "placeholder");
    static Denomination twentyNote = new Denomination("Twenty Note", 20.00, "bill", "placeholder");
    static Denomination tenNote = new Denomination("Ten Note", 10.00, "bill", "placeholder");
    static Denomination fiveNote = new Denomination("Five Note", 5.00, "bill", "placeholder");
    static Denomination oneNote = new Denomination("One Note", 1.00, "bill", "placeholder");
    static Denomination quarter = new Denomination("Quarter", 0.25, "coin", "placeholder");
    static Denomination dime = new Denomination("Dime", 0.10, "coin", "placeholder");
    static Denomination nickel = new Denomination("Nickel", 0.05, "coin", "placeholder");
    static Denomination penny = new Denomination("Penny", 0.01, "coin", "placeholder");
